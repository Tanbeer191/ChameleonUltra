...
#define TAG_SPECIFIC_TYPE_LF_VALUES \
    TAG_TYPE_EM410X, TAG_TYPE_EM410X_ELECTRA, TAG_TYPE_PAC, TAG_TYPE_HID_PROX, TAG_TYPE_IOPROX, TAG_TYPE_VIKING, TAG_TYPE_NORALSY, TAG_TYPE_JABLOTRON, TAG_TYPE_IDTECK
